...
const techPrograms = [
  {
    ...
    description: 'Learn to build applications from scratch with modern technologies',
  ...
  },
  {
    id: 5,
    title: 'DevOp',
    description: 'Combine software development and IT operation to deliver App and services faster',
    ...
    <section id="technology" className="py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-900">Technology Programs</h2>
          <p className="text-gray-600 mt-4 max-w-2xl mx-auto">
            Cutting-edge technology programs to prepare you for the digital future.
          </p>
        </div>
